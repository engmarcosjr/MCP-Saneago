---
name: "source-command-zelar"
description: "Uma rodada de zeladoria do MCP-Saneago (um item por vez, offline)"
---

# source-command-zelar

Use this skill when the user asks to run the migrated source command `zelar`.
...
- Convenção 9 do `AGENTS.md`: os ~44 scripts `.js`/`.py` soltos na raiz deveriam
