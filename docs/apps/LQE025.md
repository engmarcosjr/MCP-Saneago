...
- **U.O. do Laboratório** (input de texto, editável, maxlength 5, valor atual "V0011")
- **U.O. do Laboratório** (input de texto, somente leitura, valor atual "SUPERV. DIST. SERV. ESTAT. E. M. AP. TEC.-ANÁPOLIS")
...
- **Período de Agendamento** (input de data, editável, valor atual "11/08/2026")
- **a** (input de data, editável, valor atual "11/09/2026")
...
- "consultar amostras de esgoto no LQE025"
