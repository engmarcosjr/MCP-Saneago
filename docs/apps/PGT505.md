...
## O que faz
Permite consultar o resumo e andamento de Ordens de Tráfego (OT) no sistema de Gestão de Transportes (PGT505 - Resumo).
...
- "consultar resumo de ordem de tráfego no PGT505"
